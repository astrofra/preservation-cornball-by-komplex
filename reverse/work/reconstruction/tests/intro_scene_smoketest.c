...
int main(void)
{
    ...
    assert_equal_u32("bipyramid.front_slot", frame.bipyramid.front_texture_slot, CORNBALL_INTRO_TEXTURE_NONE);
    ...
    assert_close("overlay.tint", frame.overlay_quad.color_r, 1.0f, 0.000001f);
    ...
    assert_equal_u32("overlay.call_counter@5s", scene.overlay_state.call_counter, 2u);
    assert_close("overlay.jitter_x@5s", scene.overlay_state.jitter_x, 0.563568115f, 0.000001f);
