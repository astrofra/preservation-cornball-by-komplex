...
static void InitScreen(void)
{
    ...
    /* Write display texts: */
    vgaWriteStr(21, 1, title, 0x13, 39);
    vgaWriteText(21, 2, "\xFF\x13\x7F\x27Ä");
...
static int SelectOutputMode(int *selected)
{
    ...
    modeNum = AskSelection("Select output mode", modeStr, numModes,
        defaultMode);
