 ...
 *
 * $Id: loadxm.c,v 1.13 1997/03/05 16:49:28 pekangas Exp $
 *
...
/* Warning! Contains a horrible dos-specific hack */
...
RCSID(const char *loadxm_rcsid = "$Id: loadxm.c,v 1.13 1997/03/05 16:49:28 pekangas Exp $";)
...
//#ifdef SUPPORT_16BIT_SAMPLES
                /* We'll support 16-bit samples only with GUS for performance
                   reasons until the new mixing routines get done */
                if ( gmpSD == &GUS )
                {
