/*      mapiconf.c
 *
 * MIDAS Sound System configuration for the new MIDAS API
 *
 * $Id: mapiconf.c,v 1.1 1997/03/05 16:52:05 pekangas Exp $
 *
...
RCSID(const char *mapiconf_rcsid = "$Id: mapiconf.c,v 1.1 1997/03/05 16:52:05 pekangas Exp $";)
...
/*
 * $Log: mapiconf.c,v $
 * Revision 1.1  1997/03/05 16:52:05  pekangas
 * Initial revision
 *
